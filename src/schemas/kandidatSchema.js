...
export const pembayaranPelatihanEnum = z.enum(["BELUM", "DP", "BULAN_1", "BULAN_2", "BULAN_3", "BULAN_4", "LUNAS", "TIDAK_PELATIHAN"]);
...
export const kandidatSchema = z.object({
    ...
    alamatSesuaiKTP: z.string().min(1, "Alamat Wajib di Isi"),
...
export const updateInterviewSchema = z.object({
    interview: z.enum(["BELUM", "SIAP_INTERVIEW", "MENUNGGU_HASIL", "DITERIMA"]),
});

export const updateKandidatCPMISchema = z.object({
    nama: z.string().optional(),
    alamatSesuaiKTP: z.string().optional(),
    telephone: z.string().optional(),
    telephone_sekunder: z.string().optional(),
    namaOrangTua: z.string().optional(),
    telephoneOrtu: z.string().optional(),
    namaKerabat: z.string().optional(),
    telephoneKerabat: z.string().optional(),
    job: z.string().optional(),
    tanggalTerima: z.string().optional(),
    tanggalBerangkat: z.string().optional(),
    perusahaanPenempatan: z.string().optional(),
    kontrak: z.string().optional(),
    tempatPelatihan: z.string().optional(),
});
